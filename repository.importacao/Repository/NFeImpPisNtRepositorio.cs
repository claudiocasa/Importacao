...
{
    public class NFeImpPisNtRepositorio : IDisposable, INFeImpPisNtRepositorio
    {
        private EFContext _context;

        #region .: Construtor :.

        public NFeImpPisNtRepositorio(EFContext context)
        {
            _context = context;
        }
        ...
        public List<NFeImpPisNt> GetAllItems()
        {
            return _context.NFeImpPisNt.ToList();
        }

        public NFeImpPisNt Add(NFeImpPisNt valor)
        {
            _context.NFeImpPisNt.Add(valor);
            _context.SaveChanges();

            return valor;
        }

        public NFeImpPisNt GetById(int id)
        {
            return _context.NFeImpPisNt.Where(x => x.Id.Equals(id)).FirstOrDefault();
        }
