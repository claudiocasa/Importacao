...
{
    public class NFeImpPisAliqRepositorio : IDisposable, INFeImpPisAliqRepositorio
    {
        private EFContext _context;

        #region .: Construtor :.

        public NFeImpPisAliqRepositorio(EFContext context)
        {
            _context = context;
        }
        ...
        public List<NFeImpPisAliq> GetAllItems()
        {
            return _context.NFeImpPisAliq.ToList();
        }

        public NFeImpPisAliq Add(NFeImpPisAliq valor)
        {
            _context.NFeImpPisAliq.Add(valor);
            _context.SaveChanges();

            return valor;
        }

        public NFeImpPisAliq GetById(int id)
        {
            return _context.NFeImpPisAliq.Where(x => x.Id.Equals(id)).FirstOrDefault();
        }
