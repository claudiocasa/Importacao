...
{
    public class NFeIdeRepositorio : IDisposable, INFeIdeRepositorio
    {
        private EFContext _context;

        #region .: Construtor :.

        public NFeIdeRepositorio(EFContext context)
        {
            _context = context;
        }
        ...
        public List<NFeIde> GetAllItems()
        {
            return _context.NFeIde.ToList();
        }
        ...
        public NFeIde GetById(int id)
        {
            return _context.NFeIde.Where(x => x.Id.Equals(id)).FirstOrDefault();
        }
