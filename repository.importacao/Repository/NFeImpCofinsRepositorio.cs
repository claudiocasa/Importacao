...
{
    public class NFeImpCofinsRepositorio : IDisposable, INFeImpCofinsRepositorio
    {
        private EFContext _context;

        #region .: Construtor :.

        public NFeImpCofinsRepositorio(EFContext context)
        {
            _context = context;
        }
        ...
        public List<NFeImpCofins> GetAllItems()
        {
            return _context.NFeImpCofins.ToList();
        }

        public NFeImpCofins Add(NFeImpCofins valor)
        {
            _context.NFeImpCofins.Add(valor);
            _context.SaveChanges();

            return valor;
        }

        public NFeImpCofins GetById(int id)
        {
            return _context.NFeImpCofins.Where(x => x.Id.Equals(id)).FirstOrDefault();
        }
