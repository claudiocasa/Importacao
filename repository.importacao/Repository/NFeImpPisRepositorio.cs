...
{
    public class NFeImpPisRepositorio : IDisposable, INFeImpPisRepositorio
    {
        private EFContext _context;

        #region .: Construtor :.

        public NFeImpPisRepositorio(EFContext context)
        {
            _context = context;
        }
        ...
        public List<NFeImpPis> GetAllItems()
        {
            return _context.NFeImpPis.ToList();
        }

        public NFeImpPis Add(NFeImpPis valor)
        {
            _context.NFeImpPis.Add(valor);
            _context.SaveChanges();

            return valor;
        }

        public NFeImpPis GetById(int id)
        {
            return _context.NFeImpPis.Where(x => x.Id.Equals(id)).FirstOrDefault();
        }
